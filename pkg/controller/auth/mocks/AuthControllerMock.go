...
// AuthControllerMock is an autogenerated mock type for the ThingsBoardAuthController type
type AuthControllerMock struct {
	mock.Mock
}

// ChangePassword provides a mock function with given fields: changePasswordBody, token
func (_m *AuthControllerMock) ChangePassword(changePasswordBody core.ChangePasswordBody, token string) (int, map[string]interface{}, error) {
...
func (_m *AuthControllerMock) GetUser(token string) (int, map[string]interface{}, error) {
	ret := _m.Called(token)
...
func (_m *AuthControllerMock) Login(loginBody core.LoginBody) (int, map[string]interface{}, error) {
...
func (_m *AuthControllerMock) Logout(token string) (int, map[string]interface{}, error) {
	ret := _m.Called(token)
...
func (_m *AuthControllerMock) RefreshToken(refreshTokenBody core.RefreshTokenBody) (int, map[string]interface{}, error) {
