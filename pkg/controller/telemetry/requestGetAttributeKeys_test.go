...
func TestFailRequestGetAttributeKeys(t *testing.T) {
	t.Parallel()
	...
	URL := "/api/plugins/telemetry/USER/" + "00000000-0000-0000-0000-000000000000" + "/keys/attributes"
	...
	status, _, _ := controller.GetAttributeKeys("USER", "00000000-0000-0000-0000-000000000000", "Bearer token_value")
