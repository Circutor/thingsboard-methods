...
func TestGetAttributesSuccess(t *testing.T) {
	t.Parallel()
	...
	createDevice, b := map[string]interface{}{"serialId": "00000000000003", "type": "DeviceTest"}, new(bytes.Buffer)
	...
	status, _, err := controller.GetAttributes("DEVICE", id, token, nil)
...
func TestGetAttributesDeviceNotExist(t *testing.T) {
	t.Parallel()
	...
	status, _, _ := controller.GetAttributes("DEVICE", "00000000-0000-0000-0000-000000000000", token, nil)
