...
func TestFailRequestDeleteEntityAttributes(t *testing.T) {
	t.Parallel()
	...
	request.On("CreateNewRequest", "DELETE",
		"/api/plugins/telemetry/USER/"+"00000000-0000-0000-0000-000000000000"+"/"+"SERVER_SCOPE",
	...
	status, _, _ := controller.DeleteEntityAttributes("USER",
