...
func TestFailRequestGetAttributesByScope(t *testing.T) {
	t.Parallel()
	...
	URL := "/api/plugins/telemetry/USER/" + "00000000-0000-0000-0000-000000000000" + "/values/attributes/" + "SERVER_SCOPE"
	...
	status, _, _ := controller.GetAttributesByScope(
		"USER", "00000000-0000-0000-0000-000000000000", "SERVER_SCOPE", "Bearer token_value", query)
