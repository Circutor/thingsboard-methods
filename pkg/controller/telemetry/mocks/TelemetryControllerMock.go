...
// TelemetryControllerMock is an autogenerated mock type for the ThingsBoardTelemetryController type
type TelemetryControllerMock struct {
	mock.Mock
}

// DeleteEntityAttributes provides a mock function with given fields: entityType, entityID, scope, token, query
func (_m *TelemetryControllerMock) DeleteEntityAttributes(entityType string, entityID string, scope string, token string, query map[string]interface{}) (int, map[string]interface{}, error) {
...
func (_m *TelemetryControllerMock) GetAttributeKeys(entityType string, entityID string, token string) (int, []interface{}, error) {
...
func (_m *TelemetryControllerMock) GetAttributeKeysByScope(entityType string, entityID string, scope string, token string) (int, []interface{}, error) {
...
func (_m *TelemetryControllerMock) GetAttributes(entityType string, entityID string, token string, query map[string]interface{}) (int, []interface{}, error) {
...
func (_m *TelemetryControllerMock) GetAttributesByScope(entityType string, entityID string, scope string, token string, query map[string]interface{}) (int, []interface{}, error) {
	ret := _m.Called(entityType, entityID, scope, token, query)
...
func (_m *TelemetryControllerMock) SaveDeviceAttributes(deviceID string, scope string, token string, attributesBody map[string]interface{}) (int, []interface{}, error) {
...
func (_m *TelemetryControllerMock) SaveEntityAttributesV2(entityType string, entityID string, scope string, token string, attributesBody map[string]interface{}) (int, []interface{}, error) {
