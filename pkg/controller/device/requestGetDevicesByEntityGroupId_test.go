...
func TestFailRequestGetDevicesByEntityGroupID(t *testing.T) {
	t.Parallel()
	...
	query := map[string]interface{}{"pageSize": 30, "page": 0}
	...
	status, _, _ := controller.GetDevicesByEntityGroupID(entityGroupID, "Bearer token_value", query)
