...
func TestFailRequestGetTenantDevice(t *testing.T) {
	t.Parallel()
	...
	query := map[string]interface{}{"deviceName": deviceName}
	...
	status, _, _ := controller.GetTenantDevice(deviceName, "Bearer token_value")
